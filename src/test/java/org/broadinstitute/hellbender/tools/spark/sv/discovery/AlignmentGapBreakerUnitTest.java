...
public class AlignmentGapBreakerUnitTest {
    ...
    public void testGappedAlignmentBreaker_OneInsertion() {
        ...
        final List<AlignedAssembly.AlignmentInterval> generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength())).collect(Collectors.toList());
    ...
    public void testGappedAlignmentBreaker_GapSizeSensitivity() {
        ...
        final List<AlignedAssembly.AlignmentInterval> generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, SVConstants.DiscoveryStepConstants.GAPPED_ALIGNMENT_BREAK_DEFAULT_SENSITIVITY, cigar.getReadLength())).collect(Collectors.toList());
    ...
    public void testGappedAlignmentBreaker_HardAndSoftClip() {
        ...
        final List<AlignedAssembly.AlignmentInterval> generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength()+1+8)).collect(Collectors.toList());
    ...
    public void testGappedAlignmentBreaker_TerminalInsertionOperatorToSoftClip() {
        ...
        List<AlignedAssembly.AlignmentInterval> generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength())).collect(Collectors.toList());
        ...
        generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength())).collect(Collectors.toList());
        Assert.assertEquals(generatedARList.size(), 2);
        Assert.assertEquals(generatedARList.get(0), new AlignedAssembly.AlignmentInterval(
    ...
    public void testGappedAlignmentBreaker_TerminalInsertionNeighboringClippings(){
        ...
        AlignedAssembly.AlignmentInterval alignmentRegion = new AlignedAssembly.AlignmentInterval(
                ...
                true, 60, 0);
        List<AlignedAssembly.AlignmentInterval> generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength()+10+70)).collect(Collectors.toList());
        ...
        alignmentRegion = new AlignedAssembly.AlignmentInterval(
                ...
                true, 60, 0);
        generatedARList = Utils.stream(AlignmentGapBreaker.breakGappedAlignment(alignmentRegion, 1, cigar.getReadLength()+10+70)).collect(Collectors.toList());
        Assert.assertEquals(generatedARList.size(), 2);
    ...
    private static Iterable<AlignedAssembly.AlignmentInterval> willThrowOnInvalidCigar(final Cigar cigar) throws GATKException {
        final AlignedAssembly.AlignmentInterval detailsDoesnotMatter = new AlignedAssembly.AlignmentInterval(
                ...
                cigar,
                true, 60, 0);
        return AlignmentGapBreaker.breakGappedAlignment(detailsDoesnotMatter, 1, cigar.getReadLength() + SVVariantDiscoveryUtils.getTotalHardClipping(cigar));
    }
}
