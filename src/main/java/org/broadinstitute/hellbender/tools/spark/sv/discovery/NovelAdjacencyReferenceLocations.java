...
public class NovelAdjacencyReferenceLocations {
    ...
    NovelAdjacencyReferenceLocations(final ChimericAlignment chimericAlignmentOld)
        ...
        endConnectionType = determineEndConnectionType(chimericAlignmentOld);

        complication = new BreakpointComplications(chimericAlignmentOld);

        final Tuple2<SimpleInterval, SimpleInterval> leftJustifiedBreakpoints = leftJustifyBreakpoints(chimericAlignmentOld, complication);
