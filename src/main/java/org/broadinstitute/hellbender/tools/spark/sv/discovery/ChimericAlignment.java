...
/**
 * See documentation in {@link ChimericAlignment_out}.
 */
...
public class ChimericAlignment {
    ...
    final byte[] assemblerGivenContigSeq;
     ...
     */
    @VisibleForTesting
    static List<ChimericAlignment> fromSplitAlignments_old(final Tuple2<Iterable<AlignedAssembly.AlignmentInterval>, byte[]> input, String assemblyId, String contigId) {
        ...
        while ( iterator.hasNext() ) {
            ...
            final ChimericAlignment ca = new ChimericAlignment(current, next, sequence, insertionAlignmentRegions, assemblyId, contigId);
    ...
    public static final class Serializer extends com.esotericsoftware.kryo.Serializer<ChimericAlignment> {
        @Override
        public void write(final Kryo kryo, final Output output, final ChimericAlignment chimericAlignmentOld) {
