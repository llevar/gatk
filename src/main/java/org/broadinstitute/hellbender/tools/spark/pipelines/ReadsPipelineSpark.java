...
public class ReadsPipelineSpark extends GATKSparkTool {
    ...
    protected void runTool(final JavaSparkContext ctx) {
        ...
        JavaPairRDD<GATKRead, ReadContextData> rddReadContext = AddContextDataToReadSpark.add(ctx, markedFilteredReadsForBQSR, getReference(), bqsrKnownVariants, joinStrategy, getReferenceSequenceDictionary(), readShardSize, readShardPadding, null);
