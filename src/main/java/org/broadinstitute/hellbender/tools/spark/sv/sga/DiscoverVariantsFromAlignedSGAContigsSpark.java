...
import static org.broadinstitute.hellbender.tools.spark.sv.sga.ContigsCollection.loadContigsCollectionKeyedByAssemblyId;
...
public final class DiscoverVariantsFromAlignedSGAContigsSpark extends GATKSparkTool {
    ...
    private String outputName = "inv_del_ins.vcf";
    ...
    protected void runTool(final JavaSparkContext ctx) {
        ...
        final JavaPairRDD<Iterable<AlignmentRegion>, byte[]> alignmentRegionsWithContigSequences
                = prepAlignmentRegionsForCalling(ctx, inputAlignments, inputAssemblies, logContigAlignmentSimpleStats).cache();
